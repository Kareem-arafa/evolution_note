...
class EducationalVideosManagementScreen extends StatefulWidget {
  static const id = '/EducationalVideosManagementScreen';
  const EducationalVideosManagementScreen({super.key});

  @override
  State<EducationalVideosManagementScreen> createState() => _EducationalVideosManagementScreenState();
}

class _EducationalVideosManagementScreenState extends State<EducationalVideosManagementScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('إدارة الفيديوهات التعليمية'),
        centerTitle: true,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            //       context,
            //       MaterialPageRoute(
            //         builder: (_) => AddEducationalVideoFormScreen(),
            //       ),
            //     ).then((_) {
            //       setState(() {});
            //     });
            ...
            Expanded(
              child: FutureBuilder(
                future: RealtimeRepository().getEducationalVideos(),
                                            ...
                                            actions: [
                                              TextButton(
                                                onPressed: () {
                                                  setState(() {
                                                    RealtimeRepository()
                                                        .removeEducationalVideo(educationalVideos[index]);
